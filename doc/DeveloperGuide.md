...
`* *` | user | find persons by tag | locate details of persons with the same tag
`* *` | user | edit a person | update persons' details without deleting then adding them again
`*` | user | edit a tag | rename tags to a represent a group better
`*` | user | view all tags | manage the list of tags used in the address book
